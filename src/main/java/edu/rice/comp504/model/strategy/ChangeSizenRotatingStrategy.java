...
public class ChangeSizenRotatingStrategy implements IUpdateStrategy{
     ...
     * Constructor.
     */
    private ChangeSizenRotatingStrategy(IUpdateStrategy[] children) {
    ...
    public static IUpdateStrategy make() {
        if (ONLY == null) {
            ...
            children[1] = RotatingStrategy.make();
            ONLY = new ChangeSizenRotatingStrategy(children);
        }
        return ONLY;
    }
