...
public class PentagonalBall extends Ball{
    private static PentagonalBall ONLY = null;
    /**
     * Constructor.
     ...
     */
    protected PentagonalBall(Point loc, int radius, Point vel, String color, IUpdateStrategy strategy, IUpdateColStrategy colStrategy, String name, boolean b,Double rotationAngle,Boolean isSwitchable,Boolean isRemoveable) {
        super(loc, radius, vel, color, strategy,colStrategy,name,false,rotationAngle,isSwitchable,isRemoveable);
    }
    /**
     * Make Function.
     */
    public static PentagonalBall make(String type,String strata,String colStragety,Boolean isSwitchable,Boolean isRemoveable) {
        ...
        //IUpdateStrategy strategy = ChangeVelocityStrategy.make();
        ...
        //IUpdateColStrategy colStrategy = VelocityStrategy.make();
        String name = "Pentagon";
        Double rotationAngle = 0.0;
        return  new PentagonalBall(loc,radius,vel,color,strategy,colStrategy,name,false,rotationAngle,isSwitchable,isRemoveable);
