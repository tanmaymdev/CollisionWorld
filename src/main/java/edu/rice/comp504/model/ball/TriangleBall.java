...
public class TriangleBall extends Ball{
    private static TriangleBall ONLY = null;
    /**
     * Constructor.
     ...
     */
    protected TriangleBall(Point loc, int radius, Point vel, String color, IUpdateStrategy strategy, IUpdateColStrategy colStrategy, String name, boolean b,Double rotationAngle,Boolean isSwitchable,Boolean isRemoveable) {
        super(loc, radius, vel, color, strategy,colStrategy,name,false,rotationAngle,isSwitchable,isRemoveable);
    }
    /**
     * Make Function.
     */
    public static TriangleBall make(String type,String strata,String colStragety,Boolean isSwitchable,Boolean isRemoveable) {
        ...
        //IUpdateColStrategy colStrategy = EatingStrategy.make();
        ...
        return new TriangleBall(loc,radius,vel,color,strategy,colStrategy,name,false,rotationAngle,isSwitchable,isRemoveable);
